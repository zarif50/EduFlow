...
<div class="card-header">
 <!-- Form to filter by class -->
<form action="{{ route('assign-teacher.list') }}" method="GET" class="row">
...
<td><a href="{{route('assign-subject.edit',$assign_teacher->id)}}" class="btn btn-primary">Edit</a></td>
<td><a href="{{route('assign-subject.delete',$assign_teacher->id)}}" onclick="return confirm('Are tou sure want to Delete?');"  class="btn btn-danger">Delete</a></td>
</tr>
@endforeach
