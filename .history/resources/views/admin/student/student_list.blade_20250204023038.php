...
<li class="breadcrumb-item active">Studebt List</li>
</ol>
</div>
</div>
</div>
...
<td>I{{$item->name}}</td>
<td>I{{$item->name}}</td>
<td>I{{$item->studentAcademicYear->name}}</td>
<td>I{{$item->studentClass->name}}</td>
<td>I{{$item->father_name->name}}</td>
<td>I{{$item->mother_name->name}}</td>
