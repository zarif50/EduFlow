...
//subject management
  ...
  //assignsubject
  Route::get('assign-subject/create', [AssignSubjectToClassController::class,'index'])->name('  Route::get('assign-subject/create', [AssignSubjectToClassController::class,'index'])->name('subject.create');
ject.create');
